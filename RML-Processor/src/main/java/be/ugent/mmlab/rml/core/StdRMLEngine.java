...
public class StdRMLEngine implements RMLEngine {
    ...
    @Override
    public void run(RMLMapping mapping,
                    String outputFile,
                    String outputFormat,
                    String graphName,
    ...
    public RMLDataset runRMLMapping(RMLDataset dataset, RMLMapping rmlMapping,
        ...
        dataset = generateRDFTriples(dataset, rmlMapping, parameters, exeTriplesMap, null);
     ...
     * @param rmlMapping
     */
    public RMLDataset generateRDFTriples(RMLDataset dataset,
        ...
        for (TriplesMap triplesMap : triplesMaps) {
            dataset = this.generateTriplesMapTriples(triplesMap, parameters, exeTriplesMap, dataset, input);
        }
    ...
    @Override
    public RMLDataset generateTriplesMapTriples(TriplesMap triplesMap,
                                                Map<String, String> parameters,
                                                String[] exeTriplesMap,
                                                RMLDataset dataset,
                                                InputStream input
    ...
    public RMLDataset startTriplesMapExecution(RMLDataset dataset,
