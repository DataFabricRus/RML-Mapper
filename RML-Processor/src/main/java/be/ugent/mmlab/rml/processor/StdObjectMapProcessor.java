...
public class StdObjectMapProcessor implements ObjectMapProcessor {
    ...
    @Override
    public void processPredicateObjectMap_ObjMap(RMLDataset dataset,
                                                 Resource subject,
                                                 IRI predicate,
    ...
    @Override
    public void processPredicateObjectMap_RefObjMap(RMLDataset dataset,
                                                    Resource subject,
                                                    IRI predicate,
...
//                    getLogicalSource().getSource().getTemplate();
    ...
    private boolean processConditions(ReferencingObjectMap referencingObjectMap, Object node) {
        ...
        ConditionReferencingObjectMap condRefObjMap =
                (ConditionReferencingObjectMap) referencingObjectMap;
        Set<Condition> conditions = condRefObjMap.getConditions();
    ...
    private void process_sameLS_noJC(RMLProcessor processor,
                                     RMLDataset dataset,
                                     Object node,
    ...
    public Map<String, String> processBindingConditions(Object node, Set<BindingCondition> bindingConditions) {
        Map<String, String> parameters = new HashMap<String, String>();
    ...
    private String handleRelevantExpression(TriplesMap map, TriplesMap parentTriplesMap) {
