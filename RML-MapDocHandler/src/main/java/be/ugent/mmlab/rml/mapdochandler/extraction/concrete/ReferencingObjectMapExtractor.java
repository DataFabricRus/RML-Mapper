...
public class ReferencingObjectMapExtractor {
    ...
    public Set<ReferencingObjectMap> processReferencingObjectMap(
        ...
        Set<ReferencingObjectMap> refObjectMaps = new HashSet<>();
        try {
            ...
            log.error("A resource was expected in object of objectMap of {}", predicateObject.stringValue());
        }
    ...
    protected ReferencingObjectMap extractReferencingObjectMap(
        ...
        try {
            ...
            IRI parentTriplesMap = (IRI) TermExtractor.extractValueFromTermMap(
                    repository, object, R2RMLVocabulary.R2RMLTerm.PARENT_TRIPLES_MAP);
            ...
            if (graphMap != null) {
                ...
                graphMap = graphMapExtractor.extractGraphMap(repository, (Resource) graphMap.getConstantValue());
            }
            if (graphMap != null)
    ...
    private Set<JoinCondition> extractJoinConditions(Repository repository, Resource object) {
        RepositoryResult<Statement> statements;
        Set<JoinCondition> result = new HashSet<>();
        try {
